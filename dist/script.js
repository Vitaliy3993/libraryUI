...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.scaleOff = function (duration, fin) {
  for (let i = 0; i < this.length; i++) {
    const _fadeOut = complection => {
...
_core__WEBPACK_IMPORTED_MODULE_0__["default"].prototype.scaleIn = function (duration, fin) {
  for (let i = 0; i < this.length; i++) {
    const _fadeOut = complection => {
      this[i].style.opacity = complection;
